...
#export CHECKPOINT_ENDPOINT=/workspace/team_code/results_parked_7.json

export ROUTES=/workspace/team_code/route_test_hard_break.xml
export CHECKPOINT_ENDPOINT=/workspace/team_code/results_hard_break.json
